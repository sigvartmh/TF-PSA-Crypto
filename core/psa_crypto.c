...
#endif /* (defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_SPAKE2P_KEY_PAIR_IMPORT) ||
        * defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_SPAKE2P_PUBLIC_KEY)) */
    }
    ...
    if (PSA_KEY_TYPE_IS_PUBLIC_KEY(type) &&
        ...
        * defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_DH_PUBLIC_KEY) */
...
#if (defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_SPAKE2P_KEY_PAIR_EXPORT) && \
        defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_SPAKE2P_PUBLIC_KEY))
        return mbedtls_psa_spake2p_export_public_key(attributes,
                                                     ...
                                                     bits);
#else
        /* We don't know how to convert a private SPAKE2P key pair to public */
        return PSA_ERROR_NOT_SUPPORTED;
#endif /* (defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_SPAKE2P_KEY_PAIR_EXPORT) &&
        * defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_SPAKE2P_PUBLIC_KEY)) */
    } else {
        (void) key_buffer;
        (void) key_buffer_size;
